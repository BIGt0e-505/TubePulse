...
- ~~`./build-and-release.sh 3.1.0 master`~~ — **DONE**: shipped as v3.1.0 (2026-06-03 18:51 UTC), then a series of patch releases v3.1.1 → v3.1.6 (current, 2026-06-04 09:41 UTC)
...
- ~~Tag v3.1.0~~ — tagged; current tag is v3.1.6
